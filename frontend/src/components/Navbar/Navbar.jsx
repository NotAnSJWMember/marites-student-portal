            ...
            <div className={styles.itemContainer}>
              ...
              >
                <button
                  type="button"
                  className={
                    activeTab === "enrolledCourses" ? styles.active : ""
                  }
                >
            ...
            <div className={styles.itemContainer}>
              ...
              >
                <button
                  type="button"
                  className={
                    activeTab === "userManagement" ? styles.active : ""
                  }
                >
              ...
              >
                <button
                  type="button"
                  className={
                    activeTab === "academicPlanner" ? styles.active : ""
                  }
                >
                  <TbCertificate size={ICON_SIZE} />
                  Academic Planner
              ...
              >
                <button
                  type="button"
                  className={
                    activeTab === "systemSettings" ? styles.active : ""
                  }
                >
              ...
              >
                <button
                  type="button"
                  className={
                    activeTab === "manageNotifications" ? styles.active : ""
                  }
                >
                  <TbSpeakerphone size={ICON_SIZE} />
